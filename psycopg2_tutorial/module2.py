...
layername = 'bg_gi.second_gen_flood_maps'
...
for file in glob.glob("*.shp"):
    ...
    if type == "i":
        RP = num_meta; rainDepth = "\'\'"; duration = num_meta
        ...
        '-a_srs EPSG:3826 ', '-t_srs EPSG:3826 ', '-sql "SELECT CLASS AS class, ' + RP + ' AS rp, ' + rainDepth + \
        ' AS rainfall_depth, ' + duration + ' AS duration FROM ' + filename + '"', ' -append '
